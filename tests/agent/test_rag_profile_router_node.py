"""Tests for agent rag_profile_router validation."""
...
from agent.capabilities.rag_profile_router.node import (
    _extract_profile_from_args,
    _validate_profile,
    rag_profile_router_node,
)
from agent.capabilities.rag_profile_router.profile import (
